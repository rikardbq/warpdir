...
Let's say `wd dev` leads to `/home/rikardbq/my/dev` which has a sub-directory path that continues as `frontend/src/assets`\
then we can do `$ wd dev/frontend/src/assets`
